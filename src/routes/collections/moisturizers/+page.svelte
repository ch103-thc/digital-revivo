<script>
    ...
    // Extract unique brands from moisturizers - now using the brand property
    const brands = [
        ...new Set(moisturizerCards.map((card) => card.brand)),
    ].sort();

    // Extract unique categories from moisturizers
    const categories = [
        ...new Set(moisturizerCards.map((card) => card.category)),
    ];
    ...
    $: filteredProducts = moisturizerCards
...
<section class="moisturizers-page">
    ...
    <nav class="breadcrumb">
        ...
        <span class="separator">/</span>
        <span class="current">Moisturizers</span>
    </nav>
    ...
    <div class="header-section">
        ...
        <p class="product-count">
            {#if hasActiveFilters}
                {sortedProducts.length} of {moisturizerCards.length} products
            {:else}
                {moisturizerCards.length} products
            {/if}
        </p>
    </div>
    ...
    <div class="description">
        <p>
            Korean moisturizers are formulated with innovative ingredients and
            lightweight textures that provide deep hydration without feeling
            heavy or greasy. From gel-based formulas perfect for oily skin to
            rich creams for dry skin types, these products deliver optimal
            moisture balance.
        </p>
        <p>
            The key to Korean moisturizing lies in layering - starting with
            lightweight essences and serums, then sealing in hydration with the
            perfect moisturizer for your skin type. Many Korean moisturizers
            feature unique ingredients like snail mucin, rice water, heartleaf,
            and ceramides that not only hydrate but also repair and protect the
            skin barrier.
        </p>
    </div>
    <!-- Filters Section -->
