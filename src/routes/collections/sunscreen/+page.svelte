<script>
    ...
    // Extract unique brands from sunscreens - now using the brand property
    const brands = [
        ...new Set(sunscreenCards.map((card) => card.brand)),
    ].sort();

    // Extract unique categories from sunscreens
    const categories = [
        ...new Set(sunscreenCards.map((card) => card.category)),
    ];
    ...
    $: filteredProducts = sunscreenCards
...
<section class="sunscreens-page">
    ...
    <nav class="breadcrumb">
        ...
        <span class="separator">/</span>
        <span class="current">Sunscreen</span>
    </nav>
    ...
    <div class="header-section">
        ...
        <p class="product-count">
            {#if hasActiveFilters}
                {sortedProducts.length} of {sunscreenCards.length} products
            {:else}
                {sunscreenCards.length} products
            {/if}
        </p>
    </div>
    ...
    <div class="description">
        <p>
            Protect your skin every day with our curated selection of
            sunscreens. Whether you're heading outdoors or working near a
            window, sunscreen is essential for shielding your skin from harmful
            UVA and UVB rays that cause premature aging, sunburn, and long-term
            damage.
        </p>
        <p>
            From lightweight gels to hydrating creams and mineral formulas,
            discover SPF solutions that suit every skin type and concern —
            including sensitive, oily, or acne-prone skin. Start your daily
            routine with the best protection for a healthy, radiant complexion.
        </p>
    </div>
