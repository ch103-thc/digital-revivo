<script>
    ...
    // Extract unique brands from acne patches - now using the brand property
    const brands = [...new Set(acneCards.map((card) => card.brand))].sort();

    // Extract unique categories from acne patches
    const categories = [...new Set(acneCards.map((card) => card.category))];
...
<section class="acne-page">
    ...
    <nav class="breadcrumb">
        ...
        <span class="separator">/</span>
        <span class="current">Acne Patches</span>
    </nav>
    ...
    <div class="header-section">
        ...
        <p class="product-count">
            {#if hasActiveFilters}
                {sortedProducts.length} of {acneCards.length} products
            {:else}
                {acneCards.length} products
            {/if}
        </p>
    </div>
    ...
    <div class="description">
        <p>
            Acne patches are a game-changing skincare solution designed to
            target breakouts quickly, cleanly, and effectively. These small,
            discreet stickers work by protecting pimples from dirt, bacteria,
            and picking—while delivering active ingredients like salicylic acid,
            tea tree oil, or hydrocolloid to speed up healing.
        </p>
        <p>
            Whether you're dealing with occasional spots or persistent acne,
            acne patches offer a simple, mess-free way to treat blemishes day or
            night. Explore our range of acne patches tailored for different skin
            concerns and see clearer skin, one patch at a time.
        </p>
    </div>
